-- CalculationsModule direct test
...
describe("CalculationsModuleDirect", function()
  it("should direct-load-calculations_module", function()
    local setup = calculations_module_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-calculations_module", setup.live and "live" or "unit")
...
function calculations_module_direct_setup(mockres)
