...
describe("TesseractCubeDirect", function()
  it("should direct-load-tesseract_cube", function()
    local setup = tesseract_cube_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-tesseract_cube", setup.live and "live" or "unit")
...
function tesseract_cube_direct_setup(mockres)
