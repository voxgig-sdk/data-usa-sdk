...
describe("TesseractSchemaDirect", function()
  it("should direct-list-tesseract_schema", function()
    local setup = tesseract_schema_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-tesseract_schema", setup.live and "live" or "unit")
...
function tesseract_schema_direct_setup(mockres)
