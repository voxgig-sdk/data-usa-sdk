...
describe("TesseractModuleDirect", function()
  it("should direct-load-tesseract_module", function()
    local setup = tesseract_module_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-tesseract_module", setup.live and "live" or "unit")
...
function tesseract_module_direct_setup(mockres)
