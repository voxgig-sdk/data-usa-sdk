...
describe("ModuleStatusDirect", function()
  it("should direct-load-module_status", function()
    local setup = module_status_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-module_status", setup.live and "live" or "unit")
...
function module_status_direct_setup(mockres)
