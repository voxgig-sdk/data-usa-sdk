-- EconomicComplexityModule direct test
...
describe("EconomicComplexityModuleDirect", function()
  it("should direct-load-economic_complexity_module", function()
    local setup = economic_complexity_module_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-economic_complexity_module", setup.live and "live" or "unit")
...
function economic_complexity_module_direct_setup(mockres)
