...
describe("RouteIndexGetDirect", function()
  it("should direct-load-route_index_get", function()
    local setup = route_index_get_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-route_index_get", setup.live and "live" or "unit")
...
function route_index_get_direct_setup(mockres)
