...
local TesseractCubeEntity = {}
TesseractCubeEntity.__index = TesseractCubeEntity


function TesseractCubeEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, TesseractCubeEntity)
  self._name = "tesseract_cube"
  self._client = client
...
function TesseractCubeEntity:get_name()
  return self._name
end


function TesseractCubeEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return TesseractCubeEntity.new(self._client, opts)
end
...
function TesseractCubeEntity:mark_deleted()
  self._deleted = true
end


function TesseractCubeEntity:deleted()
  return true == self._deleted
end


function TesseractCubeEntity:data_set(args)
  if args ~= nil then
...
function TesseractCubeEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function TesseractCubeEntity:match_set(args)
  if args ~= nil then
...
function TesseractCubeEntity:match_get()
...
function TesseractCubeEntity:stream(action, args, callopts)
...
function TesseractCubeEntity:_run_op(ctx, post_done)
  local utility = self._utility
