...
local CalculationsModuleEntity = {}
CalculationsModuleEntity.__index = CalculationsModuleEntity


function CalculationsModuleEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CalculationsModuleEntity)
  self._name = "calculations_module"
  self._client = client
...
function CalculationsModuleEntity:get_name()
  return self._name
end


function CalculationsModuleEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CalculationsModuleEntity.new(self._client, opts)
end
...
function CalculationsModuleEntity:mark_deleted()
  self._deleted = true
end


function CalculationsModuleEntity:deleted()
  return true == self._deleted
end


function CalculationsModuleEntity:data_set(args)
  if args ~= nil then
...
function CalculationsModuleEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CalculationsModuleEntity:match_set(args)
  if args ~= nil then
...
function CalculationsModuleEntity:match_get()
...
function CalculationsModuleEntity:stream(action, args, callopts)
...
---@param reqmatch CalculationsModuleLoadMatch
---@param ctrl? table
---@return CalculationsModule
---@return string? err
function CalculationsModuleEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function CalculationsModuleEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return CalculationsModuleEntity
