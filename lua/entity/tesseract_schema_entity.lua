...
local TesseractSchemaEntity = {}
TesseractSchemaEntity.__index = TesseractSchemaEntity


function TesseractSchemaEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, TesseractSchemaEntity)
  self._name = "tesseract_schema"
  self._client = client
...
function TesseractSchemaEntity:get_name()
  return self._name
end


function TesseractSchemaEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return TesseractSchemaEntity.new(self._client, opts)
end
...
function TesseractSchemaEntity:mark_deleted()
  self._deleted = true
end


function TesseractSchemaEntity:deleted()
  return true == self._deleted
end


function TesseractSchemaEntity:data_set(args)
  if args ~= nil then
...
function TesseractSchemaEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function TesseractSchemaEntity:match_set(args)
  if args ~= nil then
...
function TesseractSchemaEntity:match_get()
...
function TesseractSchemaEntity:stream(action, args, callopts)
...
function TesseractSchemaEntity:_run_op(ctx, post_done)
  local utility = self._utility
