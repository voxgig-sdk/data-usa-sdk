...
local TesseractModuleEntity = {}
TesseractModuleEntity.__index = TesseractModuleEntity


function TesseractModuleEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, TesseractModuleEntity)
  self._name = "tesseract_module"
  self._client = client
...
function TesseractModuleEntity:get_name()
  return self._name
end


function TesseractModuleEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return TesseractModuleEntity.new(self._client, opts)
end
...
function TesseractModuleEntity:mark_deleted()
  self._deleted = true
end


function TesseractModuleEntity:deleted()
  return true == self._deleted
end


function TesseractModuleEntity:data_set(args)
  if args ~= nil then
...
function TesseractModuleEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function TesseractModuleEntity:match_set(args)
  if args ~= nil then
...
function TesseractModuleEntity:match_get()
...
function TesseractModuleEntity:stream(action, args, callopts)
...
function TesseractModuleEntity:_run_op(ctx, post_done)
  local utility = self._utility
