...
local RouteIndexGetEntity = {}
RouteIndexGetEntity.__index = RouteIndexGetEntity


function RouteIndexGetEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, RouteIndexGetEntity)
  self._name = "route_index_get"
  self._client = client
...
function RouteIndexGetEntity:get_name()
  return self._name
end


function RouteIndexGetEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return RouteIndexGetEntity.new(self._client, opts)
end
...
function RouteIndexGetEntity:mark_deleted()
  self._deleted = true
end


function RouteIndexGetEntity:deleted()
  return true == self._deleted
end


function RouteIndexGetEntity:data_set(args)
  if args ~= nil then
...
function RouteIndexGetEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function RouteIndexGetEntity:match_set(args)
  if args ~= nil then
...
function RouteIndexGetEntity:match_get()
...
function RouteIndexGetEntity:stream(action, args, callopts)
...
function RouteIndexGetEntity:_run_op(ctx, post_done)
  local utility = self._utility
