...
local EconomicComplexityModuleEntity = {}
EconomicComplexityModuleEntity.__index = EconomicComplexityModuleEntity


function EconomicComplexityModuleEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EconomicComplexityModuleEntity)
  self._name = "economic_complexity_module"
  self._client = client
...
function EconomicComplexityModuleEntity:get_name()
  return self._name
end


function EconomicComplexityModuleEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return EconomicComplexityModuleEntity.new(self._client, opts)
end
...
function EconomicComplexityModuleEntity:mark_deleted()
  self._deleted = true
end


function EconomicComplexityModuleEntity:deleted()
  return true == self._deleted
end


function EconomicComplexityModuleEntity:data_set(args)
  if args ~= nil then
...
function EconomicComplexityModuleEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EconomicComplexityModuleEntity:match_set(args)
  if args ~= nil then
...
function EconomicComplexityModuleEntity:match_get()
...
function EconomicComplexityModuleEntity:stream(action, args, callopts)
...
function EconomicComplexityModuleEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return EconomicComplexityModuleEntity
