...
class DataUsaSDK {
  ...
  async graphql(query: string, variables?: any, ctrl?: any) {
    ...
    if (null != errors && Array.isArray(errors) && 0 < errors.length) {
      ...
      const err: any = new Error('DataUsaSDK: graphql: ' +
  ...
  CalculationsModule(entopts?: Record<string, any>) {
    const self = this
    return new CalculationsModuleEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  EconomicComplexityModule(entopts?: Record<string, any>) {
    const self = this
    return new EconomicComplexityModuleEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  ModuleStatus(entopts?: Record<string, any>) {
    const self = this
    return new ModuleStatusEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  RouteIndexGet(entopts?: Record<string, any>) {
    const self = this
    return new RouteIndexGetEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  TesseractCube(entopts?: Record<string, any>) {
    const self = this
    return new TesseractCubeEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  TesseractModule(entopts?: Record<string, any>) {
    const self = this
    return new TesseractModuleEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  TesseractSchema(entopts?: Record<string, any>) {
    const self = this
    return new TesseractSchemaEntity(self, entopts)
  }
