...
(0, node_test_1.describe)('TesseractSchemaDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-tesseract_schema', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-tesseract_schema', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['DATA_USA_TEST_TESSERACT_SCHEMA_ENTID'];
...
//# sourceMappingURL=TesseractSchemaDirect.test.js.map