...
(0, node_test_1.describe)('TesseractCubeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-tesseract_cube', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-tesseract_cube', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['DATA_USA_TEST_TESSERACT_CUBE_ENTID'];
...
//# sourceMappingURL=TesseractCubeDirect.test.js.map