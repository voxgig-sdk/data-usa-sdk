...
(0, node_test_1.describe)('EconomicComplexityModuleDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-economic_complexity_module', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-economic_complexity_module', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.DATA_USA_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.DataUsaSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['DATA_USA_TEST_ECONOMIC_COMPLEXITY_MODULE_ENTID'];
    ...
    const client = new __1.DataUsaSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=EconomicComplexityModuleDirect.test.js.map