...
(0, node_test_1.describe)('ModuleStatusEntity', async () => {
    ...
    (0, node_test_1.test)('instance', async () => {
        ...
        const ent = testsdk.ModuleStatus();
        (0, node_assert_1.default)(null != ent);
    });
    (0, node_test_1.test)('basic', async (t) => {
        const live = 'TRUE' === process.env.DATA_USA_TEST_LIVE;
        for (const op of ['load']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'module_status.' + op, live))
                return;
        }
        ...
        let module_status_ref01_data = Object.values(setup.data.existing.module_status)[0];
        // LOAD
        const module_status_ref01_ent = client.ModuleStatus();
        const module_status_ref01_match_dt0 = {};
        const module_status_ref01_data_dt0 = (await module_status_ref01_ent.load(module_status_ref01_match_dt0)).data();
        (0, node_assert_1.default)(null != module_status_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/module_status/ModuleStatusTestData.json');
    ...
    let idmap = transform(['module_status01', 'module_status02', 'module_status03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    idmap = env['DATA_USA_TEST_MODULE_STATUS_ENTID'];
...
//# sourceMappingURL=ModuleStatusEntity.test.js.map