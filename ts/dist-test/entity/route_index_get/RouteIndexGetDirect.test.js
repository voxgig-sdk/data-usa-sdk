...
(0, node_test_1.describe)('RouteIndexGetDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-route_index_get', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-route_index_get', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['DATA_USA_TEST_ROUTE_INDEX_GET_ENTID'];
...
//# sourceMappingURL=RouteIndexGetDirect.test.js.map