...
function envOverride(m) {
    if ('TRUE' === process.env.DATA_USA_TEST_LIVE ||
        'TRUE' === process.env.DATA_USA_TEST_OVERRIDE) {
    ...
    m.DATA_USA_TEST_EXPLAIN = process.env.DATA_USA_TEST_EXPLAIN || m.DATA_USA_TEST_EXPLAIN;
    return m;
}
