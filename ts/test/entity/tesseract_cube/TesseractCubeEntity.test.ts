...
describe('TesseractCubeEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['load']) {
      if (maybeSkipControl(t, 'entityOp', 'tesseract_cube.' + op, live)) return
    }
...
function basicSetup(extra?: any) {
  ...
  const entityDataFile =
    Path.resolve(__dirname, 
      '../../../../.sdk/test/entity/tesseract_cube/TesseractCubeTestData.json')
  ...
  const idmapEnvVal = process.env['DATA_USA_TEST_TESSERACT_CUBE_ENTID']
