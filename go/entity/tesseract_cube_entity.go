...
type TesseractCubeEntity struct {
	name    string
...
func NewTesseractCubeEntity(client *core.DataUsaSDK, entopts map[string]any) *TesseractCubeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TesseractCubeEntity) GetName() string { return e.name }
...
func (e *TesseractCubeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TesseractCubeEntity) Deleted() bool {
	return e.deleted
}


func (e *TesseractCubeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTesseractCubeEntity(e.client, opts)
}

func (e *TesseractCubeEntity) Data(args ...any) any {
...
func (e *TesseractCubeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an TesseractCube; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TesseractCubeEntity) DataTyped(data ...TesseractCube) TesseractCube {
	if len(data) > 0 {
		return typedFrom[TesseractCube](e.Data(asMap(data[0])))
	}
	return typedFrom[TesseractCube](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through TesseractCube (all fields
// optional at the wire level).
func (e *TesseractCubeEntity) MatchTyped(match ...TesseractCube) TesseractCube {
	if len(match) > 0 {
		return typedFrom[TesseractCube](e.Match(asMap(match[0])))
	}
	return typedFrom[TesseractCube](e.Match())
}
...
func (e *TesseractCubeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TesseractCubeEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TesseractCubeLoadMatch and returns an TesseractCube. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *TesseractCubeEntity) LoadTyped(reqmatch TesseractCubeLoadMatch, ctrl map[string]any) (TesseractCube, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return TesseractCube{}, err
	}
	return typedFrom[TesseractCube](res), nil
}



func (e *TesseractCubeEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *TesseractCubeEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TesseractCubeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TesseractCubeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TesseractCubeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
