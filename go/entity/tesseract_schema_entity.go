...
type TesseractSchemaEntity struct {
	name    string
...
func NewTesseractSchemaEntity(client *core.DataUsaSDK, entopts map[string]any) *TesseractSchemaEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TesseractSchemaEntity) GetName() string { return e.name }
...
func (e *TesseractSchemaEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TesseractSchemaEntity) Deleted() bool {
	return e.deleted
}


func (e *TesseractSchemaEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTesseractSchemaEntity(e.client, opts)
}

func (e *TesseractSchemaEntity) Data(args ...any) any {
...
func (e *TesseractSchemaEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an TesseractSchema; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TesseractSchemaEntity) DataTyped(data ...TesseractSchema) TesseractSchema {
	if len(data) > 0 {
		return typedFrom[TesseractSchema](e.Data(asMap(data[0])))
	}
	return typedFrom[TesseractSchema](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through TesseractSchema (all fields
// optional at the wire level).
func (e *TesseractSchemaEntity) MatchTyped(match ...TesseractSchema) TesseractSchema {
	if len(match) > 0 {
		return typedFrom[TesseractSchema](e.Match(asMap(match[0])))
	}
	return typedFrom[TesseractSchema](e.Match())
}
...
func (e *TesseractSchemaEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TesseractSchemaEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *TesseractSchemaEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TesseractSchemaListMatch and returns []TesseractSchema. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *TesseractSchemaEntity) ListTyped(reqmatch TesseractSchemaListMatch, ctrl map[string]any) ([]TesseractSchema, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[TesseractSchema](res), nil
}



func (e *TesseractSchemaEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TesseractSchemaEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TesseractSchemaEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TesseractSchemaEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
