...
type CalculationsModuleEntity struct {
	name    string
...
func NewCalculationsModuleEntity(client *core.DataUsaSDK, entopts map[string]any) *CalculationsModuleEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CalculationsModuleEntity) GetName() string { return e.name }
...
func (e *CalculationsModuleEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CalculationsModuleEntity) Deleted() bool {
	return e.deleted
}


func (e *CalculationsModuleEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCalculationsModuleEntity(e.client, opts)
}

func (e *CalculationsModuleEntity) Data(args ...any) any {
...
func (e *CalculationsModuleEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CalculationsModule; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CalculationsModuleEntity) DataTyped(data ...CalculationsModule) CalculationsModule {
	if len(data) > 0 {
		return typedFrom[CalculationsModule](e.Data(asMap(data[0])))
	}
	return typedFrom[CalculationsModule](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CalculationsModule (all fields
// optional at the wire level).
func (e *CalculationsModuleEntity) MatchTyped(match ...CalculationsModule) CalculationsModule {
	if len(match) > 0 {
		return typedFrom[CalculationsModule](e.Match(asMap(match[0])))
	}
	return typedFrom[CalculationsModule](e.Match())
}
...
func (e *CalculationsModuleEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CalculationsModuleEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CalculationsModuleLoadMatch and returns an CalculationsModule. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CalculationsModuleEntity) LoadTyped(reqmatch CalculationsModuleLoadMatch, ctrl map[string]any) (CalculationsModule, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return CalculationsModule{}, err
	}
	return typedFrom[CalculationsModule](res), nil
}



func (e *CalculationsModuleEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *CalculationsModuleEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CalculationsModuleEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CalculationsModuleEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CalculationsModuleEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
