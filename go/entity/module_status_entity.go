...
func NewModuleStatusEntity(client *core.DataUsaSDK, entopts map[string]any) *ModuleStatusEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ModuleStatusEntity) GetName() string { return e.name }
...
func (e *ModuleStatusEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ModuleStatusEntity) Deleted() bool {
	return e.deleted
}


func (e *ModuleStatusEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewModuleStatusEntity(e.client, opts)
}

func (e *ModuleStatusEntity) Data(args ...any) any {
...
func (e *ModuleStatusEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ModuleStatus; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ModuleStatusEntity) DataTyped(data ...ModuleStatus) ModuleStatus {
	if len(data) > 0 {
		return typedFrom[ModuleStatus](e.Data(asMap(data[0])))
	}
	return typedFrom[ModuleStatus](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ModuleStatus (all fields
// optional at the wire level).
func (e *ModuleStatusEntity) MatchTyped(match ...ModuleStatus) ModuleStatus {
	if len(match) > 0 {
		return typedFrom[ModuleStatus](e.Match(asMap(match[0])))
	}
	return typedFrom[ModuleStatus](e.Match())
}
...
func (e *ModuleStatusEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ModuleStatusEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ModuleStatusLoadMatch and returns an ModuleStatus. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ModuleStatusEntity) LoadTyped(reqmatch ModuleStatusLoadMatch, ctrl map[string]any) (ModuleStatus, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return ModuleStatus{}, err
	}
	return typedFrom[ModuleStatus](res), nil
}



func (e *ModuleStatusEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ModuleStatusEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ModuleStatusEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ModuleStatusEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ModuleStatusEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
