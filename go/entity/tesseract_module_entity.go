...
type TesseractModuleEntity struct {
	name    string
...
func NewTesseractModuleEntity(client *core.DataUsaSDK, entopts map[string]any) *TesseractModuleEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TesseractModuleEntity) GetName() string { return e.name }
...
func (e *TesseractModuleEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TesseractModuleEntity) Deleted() bool {
	return e.deleted
}


func (e *TesseractModuleEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTesseractModuleEntity(e.client, opts)
}

func (e *TesseractModuleEntity) Data(args ...any) any {
...
func (e *TesseractModuleEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *TesseractModuleEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TesseractModuleEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *TesseractModuleEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
func (e *TesseractModuleEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TesseractModuleEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TesseractModuleEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
