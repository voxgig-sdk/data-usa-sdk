...
const testSeed = `map[string]any{"entity": map[string]any{"calculations_module": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "economic_complexity_module": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "health": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "member": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "module_status": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "route_index_get": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "tesseract_cube": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "tesseract_module": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "tesseract_schema": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
