...
func TestEconomicComplexityModuleEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		economicComplexityModuleRef01DataRaw := vs.Items(core.ToMapAny(vs.GetPath(setup.data, "existing.economic_complexity_module")))
...
func economic_complexity_moduleBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("DATA_USA_TEST_ECONOMIC_COMPLEXITY_MODULE_ENTID")
	...
	idmapResolved := core.ToMapAny(env["DATA_USA_TEST_ECONOMIC_COMPLEXITY_MODULE_ENTID"])
