...
func TestRouteIndexGetEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		routeIndexGetRef01DataRaw := vs.Items(core.ToMapAny(vs.GetPath(setup.data, "existing.route_index_get")))
...
func route_index_getBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("DATA_USA_TEST_ROUTE_INDEX_GET_ENTID")
	...
	idmapResolved := core.ToMapAny(env["DATA_USA_TEST_ROUTE_INDEX_GET_ENTID"])
