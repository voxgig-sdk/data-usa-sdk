...
```go
result, err := client.CalculationsModule(nil).Load(map[string]any{"extension": "extension", "param": map[string]any{}}, nil)
if err != nil {
    panic(err)
}
fmt.Println(result)
...
```go
result, err := client.TesseractModule(nil).Load(map[string]any{"extension": "extension", "cube": "cube", "drilldown": "drilldown", "measure": "measure"}, nil)
if err != nil {
    panic(err)
}
fmt.Println(result)
