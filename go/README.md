...
## Install
```bash
go get github.com/voxgig-sdk/data-usa-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/data-usa-sdk=../path/to/github.com/voxgig-sdk/data-usa-sdk
```
...
```
github.com/voxgig-sdk/data-usa-sdk/
...
The root package (`github.com/voxgig-sdk/data-usa-sdk`) re-exports everything needed
