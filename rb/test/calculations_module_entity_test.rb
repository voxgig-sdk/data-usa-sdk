...
class CalculationsModuleEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set DATAUSA_TEST_CALCULATIONS_MODULE_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def calculations_module_basic_setup(extra)
  ...
  entid_env_raw = ENV["DATAUSA_TEST_CALCULATIONS_MODULE_ENTID"]
