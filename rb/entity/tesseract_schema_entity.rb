...
class TesseractSchemaEntity
  ...
  def make
    opts = @_entopts.dup
    TesseractSchemaEntity.new(@_client, opts)
  end
  ...
  # @return [TesseractSchema, Hash] the current TesseractSchema data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of TesseractSchema fields)
  def match_get
  ...
  #
  # @param reqmatch [TesseractSchemaListMatch, Hash, nil] match filter (any subset of
  #   TesseractSchema fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<TesseractSchema>, Array] the matching TesseractSchema items; raises DataUsaError on failure
