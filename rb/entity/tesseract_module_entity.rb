...
class TesseractModuleEntity
  ...
  def make
    opts = @_entopts.dup
    TesseractModuleEntity.new(@_client, opts)
  end
  ...
  # @return [TesseractModule, Hash] the current TesseractModule data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of TesseractModule fields)
  def match_get
  ...
  #
  # @param reqdata [TesseractModuleCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [TesseractModule, Hash] the created TesseractModule; raises DataUsaError on failure
