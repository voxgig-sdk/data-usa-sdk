...
func registerSDKWords(r *eng.Registry, client *sdk.DataUsaSDK) {
...
func runOp(client *sdk.DataUsaSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
