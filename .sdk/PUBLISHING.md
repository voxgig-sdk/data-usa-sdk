...
|---|---|---|
| `ts/` | @voxgig-sdk/data-usa-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/data-usa-sdk \
      --repository voxgig-sdk/data-usa-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/data-usa-sdk` shows it, and
`npm trust revoke @voxgig-sdk/data-usa-sdk --id=<id>` removes it.
