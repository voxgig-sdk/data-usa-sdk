...
from projectname_sdk.core.control import DataUsaControl
...
class DataUsaContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, DataUsaResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return DataUsaError(code, msg, self)
