...
from projectname_sdk import DataUsaSDK
from projectname_sdk.core.spec import DataUsaSpec
from projectname_sdk.core.result import DataUsaResult
from projectname_sdk.core.response import DataUsaResponse
from projectname_sdk.core.operation import DataUsaOperation
from projectname_sdk.core.error import DataUsaError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import DataUsaBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = DataUsaSDK.test(None, None)
        ...
        class TestInitFeature(DataUsaBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(DataUsaBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = DataUsaSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = DataUsaSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = DataUsaSDK.test(None, setup_opts)
