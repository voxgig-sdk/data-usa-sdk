...
class DataUsaTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = DataUsaTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = DataUsaTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = DataUsaTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
