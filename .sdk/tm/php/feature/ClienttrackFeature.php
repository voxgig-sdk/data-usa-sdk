...
// DataUsa SDK clienttrack feature
...
class DataUsaClienttrackFeature extends DataUsaBaseFeature
{
    ...
    public function PostConstruct(DataUsaContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'DataUsa-SDK';
