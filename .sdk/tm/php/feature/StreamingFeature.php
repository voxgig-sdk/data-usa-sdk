...
class DataUsaStreamingFeature extends DataUsaBaseFeature
{
    ...
    private function _iterate(DataUsaResult $result): \Generator
    {
    ...
    private function _streamable(DataUsaContext $ctx): bool
    {
