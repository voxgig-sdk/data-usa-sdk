...
class DataUsaProxyFeature extends DataUsaBaseFeature
{
    ...
    public function init(DataUsaContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (DataUsaContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
