...
class DataUsaRatelimitFeature extends DataUsaBaseFeature
{
    ...
    private function _acquire(DataUsaContext $ctx): void
    {
    ...
    private function _track(DataUsaContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
