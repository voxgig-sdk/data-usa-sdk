...
// DataUsa SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class DataUsaTestFeature extends DataUsaBaseFeature
{
    ...
    public function init(DataUsaContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (DataUsaContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (DataUsaContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(DataUsaContext $ctx, $op, $args): array
    {
