...
class DataUsaTimeoutFeature extends DataUsaBaseFeature
{
    ...
    private function _with_timeout(DataUsaContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(DataUsaContext $_ctx, float $ms): void
    {
        $client = $this->client;
