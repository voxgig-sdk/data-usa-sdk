...
// DataUsa SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = DataUsaOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(DataUsaOmni::structfix($now, Struct::undef()))
                        !== json_encode(DataUsaOmni::structfix($val, Struct::undef()))) {
