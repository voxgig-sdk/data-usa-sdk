...
// DataUsa SDK utility: fetcher

class DataUsaFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; DataUsaSDK/1.0)';
    ...
    public static function call(DataUsaContext $ctx, string $fullurl, array $fetchdef): array
    {
