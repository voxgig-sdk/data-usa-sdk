...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/data-usa` | `npm install @voxgig-sdk/data-usa` |
| Python | `voxgig-sdk-data-usa` | `pip install voxgig-sdk-data-usa` |
| PHP | `voxgig-sdk/data-usa` | `composer require voxgig-sdk/data-usa` |
| Golang | `github.com/voxgig-sdk/data-usa-sdk/go` | `go get github.com/voxgig-sdk/data-usa-sdk/go` |
| Ruby | `voxgig-sdk-data-usa` | `gem install voxgig-sdk-data-usa` |
| Lua | `voxgig-sdk-data-usa` | `luarocks install voxgig-sdk-data-usa` |
