...
class DataUsaTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = DataUsaTestRunner.getenv("DATA_USA_TEST_LIVE")
        override = DataUsaTestRunner.getenv("DATA_USA_TEST_OVERRIDE")
        ...
        explain = DataUsaTestRunner.getenv("DATA_USA_TEST_EXPLAIN")
