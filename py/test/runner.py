...
class DataUsaTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = DataUsaTestRunner.getenv("DATAUSA_TEST_LIVE")
        override = DataUsaTestRunner.getenv("DATAUSA_TEST_OVERRIDE")
        ...
        explain = DataUsaTestRunner.getenv("DATAUSA_TEST_EXPLAIN")
