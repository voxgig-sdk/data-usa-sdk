    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set DATA_USA_TEST_ROUTE_INDEX_GET_ENTID JSON to run live")
        client = setup["client"]
        ...
        route_index_get_ref01_data_dt0_loaded = route_index_get_ref01_ent.load(route_index_get_ref01_match_dt0, None)
...
def _route_index_get_basic_setup(extra):
    ...
    idmap_resolved = helpers.to_map(
        env.get("DATA_USA_TEST_ROUTE_INDEX_GET_ENTID"))
