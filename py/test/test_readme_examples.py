# DataUsa SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions DataUsaSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both DataUsaSDK(...) and DataUsaSDK.test(...) become
#      DataUsaSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "datausa_sdk"
_SDK_CLASS = "DataUsaSDK"
...
_ENTITIES = {
    "CalculationsModule": "calculations_module",
    "EconomicComplexityModule": "economic_complexity_module",
    "Health": "health",
    "Member": "member",
    "ModuleStatus": "module_status",
    "RouteIndexGet": "route_index_get",
    "TesseractCube": "tesseract_cube",
    "TesseractModule": "tesseract_module",
    "TesseractSchema": "tesseract_schema",
}
