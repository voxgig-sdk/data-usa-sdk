...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/data-usa-sdk/releases)) or
...
| `caption` | `str` |  |
| `name` | `str` |  |
| `type` | `str` | Types of the data the user can expect to find in the associated column. |
...
| --- | --- | --- |
| `joins` | `list` |  |
| `pagination` | `dict` | Pagination instructions. |
| `requests` | `list` |  |
