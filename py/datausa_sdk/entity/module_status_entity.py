...
class ModuleStatusEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ModuleStatusEntity(self._client, opts)
    ...
    def data_get(self) -> ModuleStatus:
    ...
    def match_get(self) -> ModuleStatus:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ModuleStatus:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ModuleStatus().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
