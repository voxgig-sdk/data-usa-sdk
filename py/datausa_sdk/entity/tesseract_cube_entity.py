...
class TesseractCubeEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return TesseractCubeEntity(self._client, opts)
    ...
    def data_get(self) -> TesseractCube:
    ...
    def match_get(self) -> TesseractCube:
    ...
    def load(self, reqmatch=None, ctrl=None) -> TesseractCube:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.TesseractCube().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
