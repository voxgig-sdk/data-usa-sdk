...
class TesseractSchemaEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return TesseractSchemaEntity(self._client, opts)
    ...
    def data_get(self) -> TesseractSchema:
    ...
    def match_get(self) -> TesseractSchema:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[TesseractSchema]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.TesseractSchema().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
