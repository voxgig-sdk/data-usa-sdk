...
from datausa_sdk.datausa_types import (
...
class EconomicComplexityModuleEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return EconomicComplexityModuleEntity(self._client, opts)
    ...
    def data_get(self) -> EconomicComplexityModule:
    ...
    def match_get(self) -> EconomicComplexityModule:
    ...
    def load(self, reqmatch=None, ctrl=None) -> EconomicComplexityModule:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.EconomicComplexityModule().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
