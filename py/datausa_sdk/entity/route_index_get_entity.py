...
class RouteIndexGetEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return RouteIndexGetEntity(self._client, opts)
    ...
    def data_get(self) -> RouteIndexGet:
    ...
    def match_get(self) -> RouteIndexGet:
    ...
    def load(self, reqmatch=None, ctrl=None) -> RouteIndexGet:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.RouteIndexGet().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
