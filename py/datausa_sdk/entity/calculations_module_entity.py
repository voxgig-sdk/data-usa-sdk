...
class CalculationsModuleEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CalculationsModuleEntity(self._client, opts)
    ...
    def data_get(self) -> CalculationsModule:
    ...
    def match_get(self) -> CalculationsModule:
    ...
    def load(self, reqmatch=None, ctrl=None) -> CalculationsModule:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.CalculationsModule().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
