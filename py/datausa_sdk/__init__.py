...
from datausa_sdk.utility import register

# Load features
from datausa_sdk.feature.base_feature import DataUsaBaseFeature
from datausa_sdk.features import _has_feature, _make_feature
...
class DataUsaSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = DataUsaUtility()
        self._utility = utility

        from datausa_sdk.config import shared_config
    ...
    def get_utility(self):
        return DataUsaUtility.copy(self._utility)
    ...
    def _op_denied(self, op):
        ...
        return {
            "ok": False,
            "err": Exception(
                "DataUsaSDK: " + op + ": operation not allowed by"
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("DataUsaSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def CalculationsModule(self, data=None) -> "CalculationsModuleEntity":
        ...
        from datausa_sdk.entity.calculations_module_entity import CalculationsModuleEntity
    ...
    def EconomicComplexityModule(self, data=None) -> "EconomicComplexityModuleEntity":
        ...
        from datausa_sdk.entity.economic_complexity_module_entity import EconomicComplexityModuleEntity
    ...
    def Health(self, data=None) -> "HealthEntity":
        ...
        from datausa_sdk.entity.health_entity import HealthEntity
    ...
    def Member(self, data=None) -> "MemberEntity":
        ...
        from datausa_sdk.entity.member_entity import MemberEntity
    ...
    def ModuleStatus(self, data=None) -> "ModuleStatusEntity":
        ...
        from datausa_sdk.entity.module_status_entity import ModuleStatusEntity
    ...
    def RouteIndexGet(self, data=None) -> "RouteIndexGetEntity":
        ...
        from datausa_sdk.entity.route_index_get_entity import RouteIndexGetEntity
    ...
    def TesseractCube(self, data=None) -> "TesseractCubeEntity":
        ...
        from datausa_sdk.entity.tesseract_cube_entity import TesseractCubeEntity
    ...
    def TesseractModule(self, data=None) -> "TesseractModuleEntity":
        ...
        from datausa_sdk.entity.tesseract_module_entity import TesseractModuleEntity
    ...
    def TesseractSchema(self, data=None) -> "TesseractSchemaEntity":
        ...
        from datausa_sdk.entity.tesseract_schema_entity import TesseractSchemaEntity
        return TesseractSchemaEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "DataUsaSDK":
        if sdkopts is None:
            sdkopts = {}
