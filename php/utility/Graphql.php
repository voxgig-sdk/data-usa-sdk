...
class DataUsaGraphql
{
    ...
    // equivalent.
    public static function body(DataUsaContext $ctx): mixed
    {
    ...
    public static function errors(DataUsaContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
