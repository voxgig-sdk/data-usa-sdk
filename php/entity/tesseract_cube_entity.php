...
// DataUsa SDK TesseractCube entity
...
class TesseractCubeEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TesseractCubeEntity($this->_client, $opts);
    }

    /**
     * @param TesseractCube|array $args TesseractCube data (assoc-array) to store.
     */
    ...
    /**
     * @return TesseractCube|array The current TesseractCube data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of TesseractCube fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of TesseractCube fields).
     */
     ...
     *
     * @param TesseractCubeLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed TesseractCubeLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TesseractCube|array The loaded TesseractCube as an assoc-array at the
