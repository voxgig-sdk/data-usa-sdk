...
// DataUsa SDK CalculationsModule entity
...
class CalculationsModuleEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "calculations_module";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new CalculationsModuleEntity($this->_client, $opts);
    }

    /**
     * @param CalculationsModule|array $args CalculationsModule data (assoc-array) to store.
     */
    ...
    /**
     * @return CalculationsModule|array The current CalculationsModule data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CalculationsModule fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CalculationsModule fields).
     */
    ...
    /**
     * Load a single CalculationsModule.
     *
     * @param CalculationsModuleLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CalculationsModuleLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CalculationsModule|array The loaded CalculationsModule as an assoc-array at the
