...
class DataUsaRbacFeature extends DataUsaBaseFeature
{
    ...
    private function _required(DataUsaContext $ctx): ?string
    {
    ...
    private function _reject(DataUsaContext $ctx, string $required): void
    {
    ...
    private function _track(DataUsaContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
