...
class DataUsaCacheFeature extends DataUsaBaseFeature
{
    ...
    private function _through(DataUsaContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
