...
class TesseractCubeEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set DATAUSA_TEST_TESSERACT_CUBE_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function tesseract_cube_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("DATAUSA_TEST_TESSERACT_CUBE_ENTID");
