...
class RouteIndexGetEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set DATAUSA_TEST_ROUTE_INDEX_GET_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function route_index_get_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("DATAUSA_TEST_ROUTE_INDEX_GET_ENTID");
