...
class ModuleStatusEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set DATA_USA_TEST_MODULE_STATUS_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
        ...
        $module_status_ref01_data_dt0_loaded = $module_status_ref01_ent->load($module_status_ref01_match_dt0, null);
...
function module_status_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("DATA_USA_TEST_MODULE_STATUS_ENTID");
