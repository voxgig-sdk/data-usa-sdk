...
class TesseractSchemaEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $base = DataUsaSDK::test($seed, null);
        $seen = iterator_to_array($base->TesseractSchema(null)->stream("list", null, null), false);
        ...
        if (isset($cfg["feature"]) && is_array($cfg["feature"]) && isset($cfg["feature"]["streaming"])) {
            ...
            $got = [];
            foreach ($sdk->TesseractSchema(null)->stream("list", null, null) as $item) {
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set DATA_USA_TEST_TESSERACT_SCHEMA_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function tesseract_schema_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("DATA_USA_TEST_TESSERACT_SCHEMA_ENTID");
