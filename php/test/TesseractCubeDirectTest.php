...
class TesseractCubeDirectTest extends TestCase
{
    public function test_direct_load_tesseract_cube(): void
    {
        $setup = tesseract_cube_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-tesseract_cube", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
