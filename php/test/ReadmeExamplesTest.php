...
// DataUsa SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (DataUsaSDK::test)
...
{
    private const SDK_CLASS = 'DataUsaSDK';
    ...
    private const SDK_BASE = 'datausa_sdk';
